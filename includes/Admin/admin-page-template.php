            ...
            <form method="post" action="options.php">
                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                value="<?php echo esc_attr( $settings['markup_percent'] ); ?>"
                                class="small-text"
                            />
                            <span>%</span>
                            <p class="description">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <select
                                id="ewheel_importer_sync_frequency"
                                name="ewheel_importer_sync_frequency"
                            >
                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                id="ewheel_importer_target_language"
                                name="ewheel_importer_target_language"
                            >
